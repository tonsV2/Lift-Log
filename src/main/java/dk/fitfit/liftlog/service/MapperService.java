...
public class MapperService {
	...
	@Autowired
	public MapperService(List<ClassMapper<? extends DomainObject, ? extends ResourceObject>> mappers) {
		for (ClassMapper<? extends DomainObject, ? extends ResourceObject> mapper : mappers) {
	...
	public <D extends DomainObject, R extends ResourceObject> ClassMapper<D, R> getMapper(Class<?> domainObjectClass) {
		return (ClassMapper<D, R>) mappers.get(domainObjectClass);
	}

	public <D extends DomainObject, R extends ResourceObject> R map(D domainObject) {
		ClassMapper<D, R> mapper = getMapper(domainObject.getClass());
		return mapper.map(domainObject);
	}

	public <D extends DomainObject, R extends ResourceObject> D map(R resourceObject) {
...
//	public <D extends DomainObject, R extends ResourceObject> Iterable<D> map(Iterable<R> domainObjects) {
	public <D extends DomainObject, R extends ResourceObject> Iterable<R> map(Iterable<D> domainObjects) {
